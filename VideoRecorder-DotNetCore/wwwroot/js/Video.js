...
recordButton.addEventListener('click', async () => {
    const videoGum = document.querySelector('video#gum');
    if (recordButton.textContent === 'Start Recording') {
        ...
        const mediaStream = videoGum.srcObject;
        await mediaStream.getTracks().forEach(track => track.stop());
        videoGum.style.display = "none";
        videoGum.srcObject = null;
...
function handleSuccess(stream) {
    ...
    codecPreferences.options.length = 0;
